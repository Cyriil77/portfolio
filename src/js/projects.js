...
window.addEventListener('load', () => {
    ...
    if (window.innerWidth > 1200) {
        ...
        // // Kwick
        // eLChildrenKwick.childNodes[1].appendChild(eLChildrenKwick.childNodes[0])
        // eLChildrenKwick.childNodes[0].appendChild(eLChildrenKwick.childNodes[1])
        ...
        // eLChildrenWebGL.childNodes[1].appendChild(eLChildrenWebGL.childNodes[0])
        // eLChildrenWebGL.childNodes[0].appendChild(eLChildrenWebGL.childNodes[1])
        ...
        // eLChildrenGlobalMagazine.childNodes[1].appendChild(eLChildrenGlobalMagazine.childNodes[0])
        // eLChildrenGlobalMagazine.childNodes[0].appendChild(eLChildrenGlobalMagazine.childNodes[1])
        ...
        // eLChildrenCrud.childNodes[1].appendChild(eLChildrenCrud.childNodes[0])
        // eLChildrenCrud.childNodes[0].appendChild(eLChildrenCrud.childNodes[1])
        ...
        // // eLChildrenLast.childNodes[1].appendChild(eLChildrenLast.childNodes[0])
        // // eLChildrenLast.childNodes[0].appendChild(eLChildrenLast.childNodes[1])
